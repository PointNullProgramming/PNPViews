...
Pod::Spec.new do |s|
  s.name             = 'PNPViews'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PNPViews.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ehardacre/PNPViews'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ehardacre' => 'hardacre.ethan@gmail.com' }
  s.source           = { :git => 'https://github.com/ehardacre/PNPViews.git', :tag => s.version.to_s }
